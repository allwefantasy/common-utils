...
import tech.mlsql.common.utils.collect.MapMakerInternalMap.Strength;
...
import static tech.mlsql.common.utils.base.Objects.firstNonNull;
import static tech.mlsql.common.utils.base.Preconditions.*;
import static tech.mlsql.common.utils.collect.MapMakerInternalMap.Strength.SOFT;
...
public final class MapMaker extends GenericMapMaker<Object, Object> {
     ...
     * {@link CacheBuilder}, with {@link #maximumSize} being
     * replaced by {@link CacheBuilder#maximumSize}. Note that {@code
     ...
     * CacheBuilder}, with {@link #softValues} being replaced by {@link
     * CacheBuilder#softValues}. Note that {@code CacheBuilder} is simply
     ...
     * @deprecated Caching functionality in {@code MapMaker} has been moved to
     * {@link CacheBuilder}, with {@link #expireAfterWrite} being
     * replaced by {@link CacheBuilder#expireAfterWrite}. Note that {@code
     * CacheBuilder} is simply an enhanced API for an implementation which was branched from
     * {@code MapMaker}.
     */
    @Deprecated
     ...
     * @deprecated Caching functionality in {@code MapMaker} has been moved to
     * {@link CacheBuilder}, with {@link #expireAfterAccess} being
     * replaced by {@link CacheBuilder#expireAfterAccess}. Note that
     ...
     * after removing an element for any reason (see removal causes in {@link MapMaker.RemovalCause}). It will
     ...
     * @deprecated Caching functionality in {@code MapMaker} has been moved to
     * {@link CacheBuilder}, with {@link #removalListener} being
     * replaced by {@link CacheBuilder#removalListener}. Note that {@code
     * CacheBuilder} is simply an enhanced API for an implementation which was branched from
     * {@code MapMaker}.
     */
    @Deprecated
    ...
    public <K, V> ConcurrentMap<K, V> makeMap() {
        ...
        return (nullRemovalCause == null)
                ...
                : new MapMaker.NullConcurrentMap<K, V>(this);
    }
     ...
     *
     * <p>New code should use {@link CacheBuilder}, which supports
     * {@linkplain CacheStats statistics} collection, introduces the
     * {@link CacheLoader} interface for loading entries into the cache
     ...
     * @return a serializable concurrent map having the requested features
     * @deprecated Caching functionality in {@code MapMaker} has been moved to
     * {@link CacheBuilder}, with {@link #makeComputingMap} being replaced
     * by {@link CacheBuilder#build}. See the
    ...
    interface RemovalListener<K, V> {
         ...
         */
        void onRemoval(MapMaker.RemovalNotification<K, V> notification);
    }
    ...
    static final class RemovalNotification<K, V> extends ImmutableEntry<K, V> {
         ...
         * {@link MapMaker.RemovalCause#EXPLICIT} nor {@link MapMaker.RemovalCause#REPLACED}).
         */
    ...
    static class NullConcurrentMap<K, V> extends AbstractMap<K, V>
        ...
        void notifyRemoval(K key, V value) {
            MapMaker.RemovalNotification<K, V> notification =
                    new MapMaker.RemovalNotification<K, V>(key, value, removalCause);
