package tech.mlsql.common.utils.os;

import tech.mlsql.common.utils.base.Splitter;
import tech.mlsql.common.utils.collect.FluentIterable;
...
public class SystemUtils {
    ...
    private static int[] toJavaVersionIntArray(String version, int limit) {
        ...
        String[] strings = FluentIterable.from(Splitter.on("._- ").split(version)).toArray(String.class);
