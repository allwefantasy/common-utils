...
public final class Resources {
     ...
     * @return the factory
     */
    public static tech.mlsql.common.utils.io.InputSupplier<InputStream> newInputStreamSupplier(URL url) {
    ...
    public static InputSupplier<InputStreamReader> newReaderSupplier(
        ...
        return tech.mlsql.common.utils.io.CharStreams.asInputSupplier(asCharSource(url, charset));
    }
    ...
    public static <T> T readLines(URL url, Charset charset,
                                  tech.mlsql.common.utils.io.LineProcessor<T> callback) throws IOException {
    ...
    public static URL getResource(String resourceName) {
        ClassLoader loader = Objects.firstNonNull(
                ...
                tech.mlsql.common.utils.io.Resources.class.getClassLoader());
